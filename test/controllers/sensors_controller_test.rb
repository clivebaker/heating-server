...
class SensorsControllerTest < ActionController::TestCase
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post :create, sensor: { calibration: @sensor.calibration, name: @sensor.name, unique_id: @sensor.unique_id }
    end
  ...
  test "should update sensor" do
    patch :update, id: @sensor, sensor: { calibration: @sensor.calibration, name: @sensor.name, unique_id: @sensor.unique_id }
    assert_redirected_to sensor_path(assigns(:sensor))
  end
